        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-5 mb-5">
                ...
                <div class="d-flex flex-column mb-3">
                    ...
                    <p class="mb-2"><i class="fa fa-map-marker text-primary mr-3" aria-hidden="true"></i>Bắc Từ Liêm, Hà Nội</p>
                    <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>n.t.hoang1821@gmail.com</p>
                    <p class="mb-2"><i class="fa fa-phone text-primary mr-3" aria-hidden="true"></i>0388963658</p>
                </div>
