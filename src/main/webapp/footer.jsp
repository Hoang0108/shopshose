            ...
            <div class="col-md-3 col-xs-6">
              <div class="footer">
                ...
                <ul class="footer-links">
                  <li>
                    <a href="#"
                      ><i class="fa fa-map-marker"></i>Bắc Từ Liêm, Hà Nội</a
                    >
                  </li>
                  <li>
                    <a href="#"><i class="fa fa-phone"></i>+388963658</a>
                  </li>
                  <li>
                    <a href="#"
                      ><i class="fa fa-envelope-o"></i>n.t.hoang1821@gmail.com</a
                    >
                  </li>
                </ul>
              </div>
          ...
          <div class="row">
            <div class="col-md-12 text-center">
              ...
              <span class="copyright">
                ...
                All rights reserved | This template is made with by Hoang
